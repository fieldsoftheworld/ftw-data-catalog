# AGENTS.md — Field boundary tiles 2025 (test)
...
- Four child collections — A5 cell aggregates at r5/r7/r8 and the thinned full-polygon archive; each carries its own PMTiles, styles, and (for cells) GeoParquet.
